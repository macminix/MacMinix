...
#define IDLE_STACK	(3*SMALL_STACK)
#define	PRINTER_STACK	(3*SMALL_STACK)
#define	WINCH_STACK	(2*SMALL_STACK)
#define	FLOP_STACK	(2*SMALL_STACK)
#define	MEM_STACK	(1*SMALL_STACK)
#define	CLOCK_STACK	(1*SMALL_STACK)
#define	SYS_STACK	(1*SMALL_STACK)
...
#ifdef THINK_C
PUBLIC char *t_stack;					/* to be aligned */
PUBLIC long t_stacksize = TOT_STACK_SPACE + ALIGNMENT - 1;
#else
